...
const $$1 = new ENV(" iRingo: ✈ TestFlight v3.1.2(2) request.beta");
															...
															default:
																switch (PATHs[2]) {
																	...
																	default:
																		switch (/[0-9a-f]{8}(-[0-9a-f]{4}){3}-[0-9a-f]{12}/.test(PATHs[2])) {
																			case true: // PATHs[2]是UUID
																				$$1.log(`⚠ PATHs[2]是UUID，替换URL.path`, "");
																			...
																			case false: // PATHs[2]不是UUID
																				if (XSessionId !== Caches.headers["X-Session-Id"]) { // sessionId不同
																					$$1.log(`⚠ sessionId不同，替换$request.headers`, "");
																					if (IfNoneMatch) {
																	...
																	case Caches?.data?.accountId: // PATHs[2]有UUID且与accountId相同
																		$$1.log(`⚠ PATHs[2]与accountId相同，更新Caches`, "");
																		Caches.headers = {
