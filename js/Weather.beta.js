 ...
 */
 async function setENV(name, platform, database) {
	...
	Settings.NextHour.HTTPHeaders = Settings.NextHour?.HTTPHeaders ? JSON.parse(Settings.NextHour.HTTPHeaders) : Settings.NextHour.HTTPHeaders // BoxJs字符串转Object
...
async function outputNextHour(apiVersion, nextHourObject, debugOptions) {
	...
	if (debugOptions?.Switch) {
		nextHour.minutes = toDebugMinutes(nextHour.minutes, debugOptions);
	}
