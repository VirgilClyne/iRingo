...
const $$1 = new ENV(" iRingo: 📺 TV v3.2.3(2) request.beta");
		...
		default:
			...
			switch (METHOD) {
								...
								case "uts-api.itunes.apple.com":
									...
									switch (PATH) {
										case "uts/v3/user/settings":
											Type = "Settings";
											$$1.log(`🚧 调试信息`, JSON.stringify(body), "");
											break;
									}									break;
				...
				default:
						...
						case "uts-api.itunes.apple.com":
							...
							switch (PATH) {
								case "uts/v3/configurations":
									...
									}									$$1.log(`🚧 调试信息`, `region = ${URL.query?.region}, country = ${URL.query?.country}, sfh = ${URL.query?.sfh}`, "");
									break;
								case "uts/v3/user/settings":
									Type = "Settings";
									$$1.log(`🚧 调试信息`, `caller = ${URL.query?.caller}, pfm = ${URL.query?.pfm}, sf = ${URL.query?.sf}`, "");
									break;
					...
					}					$$1.log(`⚠ Type = ${Type}, CC = ${Settings.CountryCode[Type]}`);
					break;
				case "CONNECT":
				case "TRACE":
					break;
			...
			$$1.log(`🚧 调试信息`, `sf = ${URL.query?.sf}, locale = ${URL.query?.locale}`, "");
