...
!(async () => {
	const { Settings, Caches = {}, Configs } = await (0,_function_setENV_mjs__WEBPACK_IMPORTED_MODULE_2__["default"])("iRingo", "PrivateRelay", DataBase);
