...
(() => {
/*!*******************************************!*\
  !*** ./src/PrivateRelay.response.beta.js ***!
  \*******************************************/
...
const $ = new _ENV_ENV_mjs__WEBPACK_IMPORTED_MODULE_0__["default"](" iRingo: ☁️ iCloud Private Relay v1.0.3(1) response.beta");
...
!(async () => {
	const { Settings, Caches = {}, Configs } = await (0,_function_setENV_mjs__WEBPACK_IMPORTED_MODULE_2__["default"])("iRingo", "Private_Relay", DataBase);
