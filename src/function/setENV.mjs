...
export default function setENV(name, platforms, database) {
	...
	switch (platforms) {
		case "WeatherKit":
			...
			if (!Array.isArray(Settings?.AQI?.Local?.ReplaceScales)) _.set(Settings, "AQI.ReplaceProviders.Local.ReplaceScales", (Settings?.AQI?.Local?.ReplaceScales) ? [Settings.AQI.Local.ReplaceScales.toString()] : []);
			break;
		case "Siri":
