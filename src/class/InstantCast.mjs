...
const EPA_NowCast_AQI_CATEGORIES = {
...
const EPA_NowCast_RANGES = {
    OZONE_8H: {
        GOOD: {
            AQI: EPA_NowCast_AQI_CATEGORIES.GOOD.RANGE,
            AMOUNT: { LOWER: 0.000, UPPER: 0.054 },
        },
        MODERATE: {
            AQI: EPA_NowCast_AQI_CATEGORIES.MODERATE.RANGE,
            AMOUNT: { LOWER: 0.055, UPPER: 0.070 },
        },
        UNHEALTHY_FOR_SENSITIVE: {
            AQI: EPA_NowCast_AQI_CATEGORIES.UNHEALTHY_FOR_SENSITIVE.RANGE,
            AMOUNT: { LOWER: 0.071, UPPER: 0.085 },
        },
        UNHEALTHY: {
            AQI: EPA_NowCast_AQI_CATEGORIES.UNHEALTHY.RANGE,
            AMOUNT: { LOWER: 0.086, UPPER: 0.105 },
        },
        VERY_UNHEALTHY: {
            AQI: EPA_NowCast_AQI_CATEGORIES.VERY_UNHEALTHY.RANGE,
    ...
    OZONE: {
        ...
        HAZARDOUS: {
            AQI: EPA_NowCast_AQI_CATEGORIES.HAZARDOUS.RANGE,
...
const EPA_NowCast = {
    ...
    SIGNIFICANT_LEVEL: EPA_NowCast_AQI_CATEGORIES.UNHEALTHY_FOR_SENSITIVE.CATEGORY_INDEX,

    AQI_CATEGORIES: Object.values(EPA_NowCast_AQI_CATEGORIES),
    POLLUTANTS: {
        OZONE_8H: {
            ...
            PPX_TO_XGM3: 1.97,
            RANGES: {
                MIN: EPA_NowCast_RANGES.OZONE_8H.GOOD,
                MAX: EPA_NowCast_RANGES.OZONE_8H.VERY_UNHEALTHY,
                ALL: Object.values(EPA_NowCast_RANGES.OZONE_8H),
            },
        },
        OZONE: {
            UNIT: 'PARTS_PER_MILLION',
            ...
            PPX_TO_XGM3: 1.97,
            RANGES: {
                MIN: EPA_NowCast_RANGES.OZONE.UNHEALTHY_FOR_SENSITIVE,
                MAX: EPA_NowCast_RANGES.OZONE.HAZARDOUS,
                ALL: Object.values(EPA_NowCast_RANGES.OZONE),
            },
        },
        PM2_5_24H: {
            ...
            PPX_TO_XGM3: -1,
            RANGES: {
                MIN: EPA_NowCast_RANGES.PM2_5_24H.GOOD,
                MAX: EPA_NowCast_RANGES.PM2_5_24H.HAZARDOUS,
                ALL: Object.values(EPA_NowCast_RANGES.PM2_5_24H),
            },
        },
        PM10_24H: {
            UNIT: 'MICROGRAMS_PER_CUBIC_METER',
            PPX_TO_XGM3: -1,
            RANGES: {
                MIN: EPA_NowCast_RANGES.PM10_24H.GOOD,
                MAX: EPA_NowCast_RANGES.PM10_24H.HAZARDOUS,
                ALL: Object.values(EPA_NowCast_RANGES.PM10_24H),
            },
        },
        CO_8H: {
            UNIT: 'PARTS_PER_MILLION',
            ...
            PPX_TO_XGM3: 1.14,
            RANGES: {
                MIN: EPA_NowCast_RANGES.CO_8H.GOOD,
                MAX: EPA_NowCast_RANGES.CO_8H.HAZARDOUS,
                ALL: Object.values(EPA_NowCast_RANGES.CO_8H),
            },
        },
        SO2: {
            ...
            PPX_TO_XGM3: 2.62,
            RANGES: {
                MIN: EPA_NowCast_RANGES.SO2.GOOD,
                MAX: EPA_NowCast_RANGES.SO2.UNHEALTHY,
                ALL: Object.values(EPA_NowCast_RANGES.SO2),
            },
        },
        SO2_24H: {
            UNIT: 'PARTS_PER_BILLION',
            PPX_TO_XGM3: -1,
            RANGES: {
                MIN: EPA_NowCast_RANGES.SO2_24H.VERY_UNHEALTHY,
                MAX: EPA_NowCast_RANGES.SO2_24H.HAZARDOUS,
                ALL: Object.values(EPA_NowCast_RANGES.SO2_24H),
            },
        },
        // NOT FOR CALCULATION
        //
        ...
        SO2_MAX_1H: {
            ...
            RANGES: {
                ...
                ALL: [{
                    ...
                    AMOUNT: {
                        LOWER: EPA_NowCast_RANGES.SO2_24H.VERY_UNHEALTHY.AMOUNT.LOWER,
        ...
        NO2: {
            ...
            PPX_TO_XGM3: 1.88,
            RANGES: {
                MIN: EPA_NowCast_RANGES.NO2.GOOD,
                MAX: EPA_NowCast_RANGES.NO2.HAZARDOUS,
                ALL: Object.values(EPA_NowCast_RANGES.NO2),
            },
        },
    },
};

const WAQI_INSTANT_CAST_RANGES = {
    OZONE: {
        GOOD: {
            AQI: EPA_NowCast_AQI_CATEGORIES.GOOD.RANGE,
...
const WAQI_INSTANT_CAST = {
    SCALE: EPA_NowCast.SCALE,
    SIGNIFICANT_LEVEL: EPA_NowCast.SIGNIFICANT_LEVEL,

    AQI_CATEGORIES: EPA_NowCast.AQI_CATEGORIES,
    POLLUTANTS: {
        ...EPA_NowCast.POLLUTANTS,
        OZONE: {
            UNIT: 'PARTS_PER_BILLION',
            PPX_TO_XGM3: EPA_NowCast.POLLUTANTS.OZONE.PPX_TO_XGM3,
            RANGES: {
                MIN: WAQI_INSTANT_CAST_RANGES.OZONE.GOOD,
                MAX: WAQI_INSTANT_CAST_RANGES.OZONE.HAZARDOUS,
                ALL: Object.values(WAQI_INSTANT_CAST_RANGES.OZONE),
            },
        },
        PM2_5: EPA_NowCast.POLLUTANTS.PM2_5_24H,
        PM10: EPA_NowCast.POLLUTANTS.PM10_24H,
        CO: EPA_NowCast.POLLUTANTS.CO_8H,
        OZONE_8H: undefined,
        PM2_5_24H: undefined,
        PM10_24H: undefined,
        CO_8H: undefined,
...
const toWAQIInstantCast = (pollutants) => {
...
export default { WAQI_INSTANT_CAST, toWAQIInstantCast };
