...
class GenericTile$Type extends MessageType {
    constructor() {
        super("GenericTile", [
            { no: 1, name: "tileType", kind: "enum", T: () => ["GenericTileType", GenericTileType] },
...
class TileSet$Type extends MessageType {
    constructor() {
        super("TileSet", [
            ...
            { no: 3, name: "style", kind: "enum", T: () => ["TileSetStyle", TileSetStyle] },
            { no: 5, name: "validVersion", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TileSetVersion },
            { no: 6, name: "scale", kind: "enum", T: () => ["TileScale", TileScale] },
            { no: 7, name: "size", kind: "enum", T: () => ["TileSize", TileSize] },
            ...
            { no: 12, name: "updateBehavior", kind: "enum", opt: true, T: () => ["TileSet.TileSetVersionUpdateBehavior", TileSet_TileSetVersionUpdateBehavior] },
            { no: 13, name: "countryRegionWhitelist", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => TileSet_CountryRegionTuple },
            { no: 14, name: "checksumType", kind: "enum", T: () => ["TileSet.TileSetChecksumType", TileSet_TileSetChecksumType] },
            { no: 15, name: "dataSet", kind: "scalar", opt: true, T: 13 /*ScalarType.UINT32*/ },
            { no: 16, name: "requestStyle", kind: "enum", T: () => ["TileSet.TileRequestStyle", TileSet_TileRequestStyle] },
...
class TileSet_CountryRegionTuple$Type extends MessageType {
    constructor() {
        super("TileSet.CountryRegionTuple", [
